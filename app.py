...
<style>
    ...
    background: linear-gradient(
        135deg,
        #b64fc8 0%,     /* medium pink-purple */
        #9c4dcc 25%,    /* deeper purple-pink */
        #7f4ac5 50%,    /* rich violet */
        #5f3eab 75%,    /* darker purple */
        #3f2d7e 100%    /* dark violet base */
    );
    ...
    /* Ensure prediction result text is visible */
    .main .block-container h1,
    .main .block-container h2,
    .main .block-container h3,
    .main .block-container p,
