...
# =============================================================================
# 4A. OPTIONAL: RESAMPLING WITH SMOTE
# =============================================================================
...
if use_smote:
    ...
    try:
        ...
        raise ImportError("imblearn is not installed. Please install it with 'pip install imbalanced-learn'.")
    print("Before SMOTE:", pd.Series(y_train).value_counts())
    smote = SMOTE(random_state=42)
    X_train, y_train = smote.fit_resample(X_train, y_train)
    print("After SMOTE:", pd.Series(y_train).value_counts())
else:
    print("SMOTE not applied. Proceeding with original class distribution.")
